// src/services/api.ts - API service corrigido para porta 3000
import axios, { AxiosError, AxiosRequestConfig, AxiosResponse } from 'axios';

// ✅ CORREÇÃO: Backend está rodando na porta 3000
...
api.interceptors.response.use(
  ...
  (error: AxiosError) => {
    ...
    if (error.code === 'ECONNREFUSED') {
      console.error('🔴 CONEXÃO RECUSADA - Verifique se backend está rodando na porta 3000');
