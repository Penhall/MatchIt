#!/bin/bash
# scripts/fix/final_style_fix.sh - Correção final do problema style preferences
# Arquivo: scripts/fix/final_style_fix.sh

# =====================================================
# CORREÇÃO FINAL - STYLE PREFERENCES UPDATE
# =====================================================
...
# Novo método updateStyleChoice corrigido
new_method = '''  /**
...
if new_content == content:
    # Procurar último método e inserir antes
    pattern = r'(\n  /\*\*.*?\n   \* Busca o perfil de um usuário.*?\n   \*/\n  async getProfileByUserId\(userId\) \{)'
    new_content = re.sub(pattern, new_method + r'\n\1', content, flags=re.DOTALL)
